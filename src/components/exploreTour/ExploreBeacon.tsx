  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1 rounded-full transition-all cursor-pointer select-none font-mono ${
        isSeen
          ...
          : 'bg-sky-500/20 hover:bg-sky-500/30 text-sky-300 border border-sky-500/50 shadow-[0_0_12px_rgba(6,182,212,0.3)] animate-pulse'
    ...
    >
      {isSeen ? (
        ...
        <Sparkles className={isSmall ? 'w-2.5 h-2.5 text-sky-300' : 'w-3 h-3 text-sky-300'} />
      )}

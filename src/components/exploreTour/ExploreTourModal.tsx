        ...
        >
          ...
          <div className="p-6 bg-gradient-to-r from-slate-900 via-blue-950/60 to-slate-900 border-b border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-slate-950 shadow-lg shadow-sky-500/25 shrink-0">
                <Compass className="w-6 h-6 stroke-[2.5]" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded-full bg-sky-500/20 text-sky-300 border border-sky-500/40 text-[10px] font-bold uppercase font-mono tracking-wider">
            ...
            <div className="flex items-center gap-2 self-end sm:self-center">
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-black text-xs transition-all shadow-md shadow-sky-500/20 flex items-center gap-1.5 cursor-pointer active:scale-95"
              >
                  ...
                  <div
                    ...
                    className={`rounded-2xl border p-4 transition-all flex flex-col justify-between gap-3 text-left ${
                      isSeen
                        ...
                        : 'bg-gradient-to-br from-slate-900 via-blue-950/20 to-slate-900 border-sky-500/30 hover:border-sky-500/60 shadow-sm'
                    }`}
                  >
                    <div>
                      {/* Card Header */}
                      <div className="flex items-start justify-between gap-2 mb-2">
                        ...
                        {isSeen ? (
                          ...
                          <span className="px-2 py-0.5 rounded-full bg-sky-500/20 text-sky-300 border border-sky-500/40 text-[10px] font-mono font-bold flex items-center gap-1 shrink-0 animate-pulse">
                      ...
                      <div className="text-xs text-sky-300/90 font-mono font-medium mb-1.5">
                    ...
                    <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/30 text-sky-300 hover:text-white text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer active:scale-95"
                      >

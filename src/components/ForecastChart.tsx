...
import { BarChart3, TrendingDown, Info, ShieldAlert } from 'lucide-react';
...
export const ForecastChart: React.FC<ForecastChartProps> = ({
  ...
  return (
    <div id="forecast-chart-card" className="bg-white rounded-xl border border-slate-200 p-5 shadow-xs">
      {/* Header */}
